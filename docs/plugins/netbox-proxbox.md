...
Official **English** Documentation can be **[found here](https://proxbox.netbox.dev.br)**!

---

## README.md from the [GitHub Repository](https://github.com/netdevopsbr/netbox-proxbox/blob/develop/README.md)
...
On **Proxmox VM/CT** page, click button ![full update button](https://github.com/N-Multifibra/proxbox/blob/main/etc/img/proxbox_full_update_button.png?raw=true "preview")
